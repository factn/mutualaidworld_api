class UserResource < JSONAPI::Resource
  ...
  attributes :city_state, :created_at, :updated_at, :hon3y

  filters :latitude, :longitude, :email, :firstname, :lastname, :street_address, :city_state, :hon3y, :created_at, :updated_at
  ...
  has_many :verified, class_name: "Vouch"
